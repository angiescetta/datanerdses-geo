...
#Filtro actividad comercial en la Ciudad: usos COMERCIAL y GASTRONOMIA Y HOTELERIA
rus2017_comercial <- rus2017 %>% 
...
ggmap(CABA) +
  geom_point(data = filter(rus2017, CATEGORIA=="COMERCIAL"), 
...
ggmap(CABA) +
  geom_bin2d(data = filter(rus2017, CATEGORIA=="COMERCIAL"),
...
ggmap(CABA) +
  geom_density2d(data = filter(rus2017, CATEGORIA=="COMERCIAL"), 
                 aes(x = X, y = Y, 
...
ggmap(CABA) +
  stat_density_2d(data = filter(rus2017, CATEGORIA=="COMERCIAL"), 
                  aes(x = X, y = Y, 
